...
public class RootLayoutController {
    ...
    private void handleNew() {
        mainApp.getGameData().clear();
        mainApp.setGameFilePath(null);
    }
    ...
    private void handleOpen() {
        ...
        if (file != null) {
            mainApp.loadGameDataFromFile(file);
        }
    }
    ...
    private void handleSave() {
        File personFile = mainApp.getGameFilePath();
        if (personFile != null) {
            mainApp.saveGameDataToFile(personFile);
        } else {
            handleSaveAs();
        }
    }
    ...
    private void handleSaveAs() {
        ...
        if (file != null) {
            ...
            mainApp.saveGameDataToFile(file);
        }
    }
